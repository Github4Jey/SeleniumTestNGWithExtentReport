...
public class ThirdSampleTSwithPageObjAndActions extends FrameworkBase{
	...
	public ThirdSampleTSwithPageObjAndActions(){
	super();
	}
	...
	@Test
	public void LoginTextBoxDisplayValidationwithHomePageThird(){		
		try {
			...
			//String name = new Object(){}.getClass().getEnclosingMethod().getName();	
			map= testData.readExcel("ThirdTCdescription");
